...
class RunCheckers:
    ...
    def __init__(self, choices='ondemandstopchecker'):
    ...
    def run_(self):
        # data_type_checker = DataTypeChecker()
        # format_checker = FormatChecker()
        # bus_line_checker = BusLineChecker()
        # bus_stop_checker = BusStopChecker()
        # stop_times_checker = StopTimesChecker()
        on_demand_stop_checker = OnDemandStopChecker()
    ...
    def on_demand_stop_checker_(self):
        for dic in self.json_data:
            ...
            if stop_name in self.sf_names.values():
                if stop_type == 'O':
                    # if bus_id not in self.incorrect_stop_types:
                    #     self.incorrect_stop_types[bus_id] = [stop_name]
                    # else:
